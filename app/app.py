...
# def submit_setlist():
#     global access_token
#     api_choice = st.selectbox("APIを選択してください", ("Spotify", "YouTube"))
...
#             components.iframe(
#                 "https://open.spotify.com/embed/playlist/" + playlist["id"], height=500
#             )
...
#                 original_artist = (
#                     song_data["cover"]["name"] if is_cover else artist_name
#                 )
#                 song = {
#                     "index": index,
#                     "name": medley_part,
...
def main():
    ...
    st.write(
        "このアプリは[setlist.fm](https://www.setlist.fm/)のURLからSpotifyのプレイリストを作成するアプリです"
    )
